...
LiquidCrystal lcd(48,255,46,52,  41,40,39,38);  //there are multiple versions of this commented below; paste 'em in
...
//======for an LCD with a single HD44780 type chip and 16 pin interface (eg 16x2 20x2 16x4 20x4) 4 data pins
